  ...
  <div class="sidebar-container" :class="{ lower: isLogoHidden }">
    ...
    <div class="menu-container">
      <div class="menu">
        ...
        <RouterLink class="custom-link" to="/leaderboard">
          <div
            class="leader"
      ...
      <div class="footer">
        <button>
          ...
          <img src="https://cssbattle.dev/images/pro-badge.svg" alt="plus icon" />
        </button>
      </div>
    </div>
  </div>
...
.sidebar-container {
  ...
  .menu-container {
    ...
    .menu {
      ...
      div:not(.home and .selection-header) {
        font-family: ClashGrotesk;
      }
      .selection-header {
        font-size: 1rem;
        @include sidebar-play;
        width: 100%;
        padding-left: 3em;
      }
    }
